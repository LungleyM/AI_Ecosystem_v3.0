# SHARED PROCEDURAL PATTERNS v1.0
...
**Example:**
```
INTELLIGENCE SYNTHESIS (STANDARD depth, 18 sources)
...
### Task Package Template (Outsourcing Work)
...
**END SHARED PROCEDURAL PATTERNS v1.0**
